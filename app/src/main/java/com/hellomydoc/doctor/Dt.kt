...
object Dt {
    ...
    fun calendar(format: String?, input: String?): Calendar? {
        ...
        Log.d("sdf_bug","$format ${sdf.parse("2021-11-20")}")
        Log.d("sdf_bug","$format ${sdf.parse("2021-11-21")}")
        Log.d("sdf_bug","$format ${sdf.parse("2021-11-22")}")
        Log.d("sdf_bug","$format ${sdf.parse("2021-11-23")}")
        sdf.isLenient = false
        return try {
